...
<body>
		...
		<div class="row">
			<div class="panel panel-default">
				...
				<div class="panel-body">
					...
					<div style="display:none;">	学习率: <input type="text" id="lrtxt" maxlength="10" value="10"
	...
	<div class="container" style="padding-left: 0px; padding-right: 0px;">
		...
		<div class="panel panel-default">
			<div class="panel-body" style="width:430px; height:335px;">
				<div class="col-sm-12">

					<div id="cost"
						style="display: none; text-align: left; font-family: Impact;"></div>
...
function initEmbedding() {
	...
	.attr("width", 474).attr("height", 312);
