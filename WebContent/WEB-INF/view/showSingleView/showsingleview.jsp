        ...
        <div class="winui-tab-left" style=" height: 450px;width: 221px;        ">
            <div class="winui-scroll-y" style="height:auto;position:absolute;top:0;bottom:0;">
                <ul class="winui-tab-nav">
                    ...
                    <li><i class="fa fa-clock-o fa-fw"></i>单视角聚类</li>
                    <li><i class="fa fa-bug fa-fw"></i>聚类可视化</li>
                </ul>
            </div>
        </div>
            ...
            <div class="winui-scroll-y">
                <div class="winui-tab-content">
                    <div class="winui-tab-item layui-show">
                       <iframe src="http://localhost:8080/SpringNMF/demo/showsingledatasetsDetail" frameborder=0 style="width:100%; min-height:700px;"></iframe>
                    </div>
                    <div class="winui-tab-item">
                        <iframe src="http://localhost:8080/SpringNMF/demo/showSingleDataAnalysis" frameborder=0 style="width:100%; min-height:700px;;"></iframe>
                    </div>
                    <div class="winui-tab-item">
                       <iframe src="http://localhost:8080/SpringNMF/demo/showCluster" frameborder=0 style="width:100%; min-height:700px;"></iframe>
                    </div>
                </div>
            </div>
        </div>
